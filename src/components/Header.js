...
function Header({ videoRef }) {
    return (
        <div className='top-0 container-header flex flex-col h-20 p-2 mb-0 sm:flex-row items-center header-container' >
            <video className='fondo-video absolute top-0 left-0 w-full h-full object-cover blur-sm' autoPlay loop muted ref={videoRef}>
